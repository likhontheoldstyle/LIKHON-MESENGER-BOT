...
module.exports = {
  config: {
    ...
    longDescription: "Search videos from YouTube and download as video"
  },
  ...
  onStart: async function ({ api, event, args, message }) {
    ...
    try {
      ...
      msgTxt += `📊 *Results:* ${list.length} videos found\n\n`;
      msgTxt += "━━━━━━━━━━━━━━━━━━━\n\n";
  ...
  onReply: async function ({ api, event, message, Reply }) {
    const { author, links, titles, messageID } = Reply;
    ...
    try {
      ...
      const videoUrl_hd = data.data.video_hd || data.data.video || data.data.video_sd;
      ...
      setTimeout(() => {
        fs.unlink(filePath, (err) => {
          if (err) console.log("Error deleting video file:", err.message);
        });
      }, 5000);
